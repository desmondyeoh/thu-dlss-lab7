...
class LoadData:
    def __init__(self, root_path):
        ...
        #you should decide the image size
        self.image_shape = (48,48) # 184,104; 56, 39
	#just one line
    ...
    def get_all_instance(self):
        ...
        for index, label in enumerate(all_labels_name):
            ...
            for instance in train_instances:
                ...
                instance_number += len(all_images_name)
            ...
            print "%s : %d : %d : %d"%(label, index, instance_number, len(all_train_rgb_samples))
